...
const escape = /* @__PURE__ */ getDefaultExportFromCjs(htmlEscapeExports);
...
async function createInertiaApp({ id = "app", resolve: resolve2, setup, progress = {}, page: page2 }) {
  const isServer = typeof window === "undefined";
...
function ThemeSelector($$payload, $$props) {
  push();
  var $$store_subs;
  $$payload.out += `<form method="post"><button class="theme-selector-wrapper svelte-1pms5cn"><input type="checkbox" name="isLight" id="isLight"${attr("checked", store_get($$store_subs ?? ($$store_subs = {}), "$currentTheme", currentTheme) === "dark", true)} class="svelte-1pms5cn"> <span class="svelte-1pms5cn">`;
  if (store_get($$store_subs ?? ($$store_subs = {}), "$currentTheme", currentTheme) === "dark") {
    $$payload.out += "<!--[-->";
    $$payload.out += `<svg fill="none" stroke="var(--svg-color)" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="svelte-1pms5cn"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path></svg>`;
  } else {
    $$payload.out += "<!--[!-->";
    $$payload.out += `<svg fill="none" stroke="var(--svg-color)" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="svelte-1pms5cn"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>`;
  }
  $$payload.out += `<!--]--></span></button></form>`;
  if ($$store_subs) unsubscribe_stores($$store_subs);
  pop();
}
function Home_outline($$payload, $$props) {
  ...
  $$payload.out += `<svg${spread_attributes(
    ...
    void 0,
    3
  )}><path fill="currentColor" d="m12 5.69l5 4.5V18h-2v-6H9v6H7v-7.81zM12 3L2 12h3v8h6v-6h2v6h6v-8h3"></path></svg>`;
}
function User_outline($$payload, $$props) {
  const { $$slots, $$events, ...p } = $$props;
  $$payload.out += `<svg${spread_attributes(
    {
      viewBox: "0 0 24 24",
    ...
    void 0,
    3
  )}><path fill="currentColor" d="M12 4a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4m0 2a2 2 0 0 0-2 2a2 2 0 0 0 2 2a2 2 0 0 0 2-2a2 2 0 0 0-2-2m0 7c2.67 0 8 1.33 8 4v3H4v-3c0-2.67 5.33-4 8-4m0 1.9c-2.97 0-6.1 1.46-6.1 2.1v1.1h12.2V17c0-.64-3.13-2.1-6.1-2.1"></path></svg>`;
}
function Logout($$payload, $$props) {
  ...
  $$payload.out += `<svg${spread_attributes(
    ...
    void 0,
    3
  )}><path fill="currentColor" d="m17 7l-1.41 1.41L18.17 11H8v2h10.17l-2.58 2.58L17 17l5-5M4 5h8V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2H4z"></path></svg>`;
}
function Format_list_bulleted($$payload, $$props) {
  const { $$slots, $$events, ...p } = $$props;
  $$payload.out += `<svg${spread_attributes(
    {
      viewBox: "0 0 24 24",
...
function Alert_outline($$payload, $$props) {
  const { $$slots, $$events, ...p } = $$props;
  $$payload.out += `<svg${spread_attributes(
    {
      viewBox: "0 0 24 24",
    ...
    void 0,
    3
  )}><path fill="currentColor" d="M12 2L1 21h22M12 6l7.53 13H4.47M11 10v4h2v-4m-2 6v2h2v-2"></path></svg>`;
}
function linkWithIcon($$payload, link) {
  $$payload.out += `<a${attr("href", link.href)}${attr_class("svelte-p8dzas", void 0, { "active": link.isActive() })}><!---->`;
  link.icon($$payload, { width: "100%", height: "100%" });
  $$payload.out += `<!----> <span>${escape_html(link.label)}</span></a>`;
}
function Sidebar($$payload, $$props) {
  ...
  const links = [
    {
      ...
      icon: Home_outline,
      label: "Dashboard",
      isActive: () => store_get($$store_subs ?? ($$store_subs = {}), "$page", page).url === "/"
    },
    {
      href: "/projects",
      icon: Format_list_bulleted,
      label: "Projects",
      isActive: () => store_get($$store_subs ?? ($$store_subs = {}), "$page", page).url.toLowerCase().startsWith("/project")
    },
    {
      href: "/alerts",
      icon: Alert_outline,
      label: "Alerts",
      isActive: () => store_get($$store_subs ?? ($$store_subs = {}), "$page", page).url.toLowerCase().startsWith("/alert")
    }
  ];
  const adminLinks = [
    {
      ...
      icon: User_outline,
      label: "Users",
      isActive: () => store_get($$store_subs ?? ($$store_subs = {}), "$page", page).url.toLowerCase().startsWith("/admin/users")
    }
  ];
  ...
  const each_array_1 = ensure_array_like(adminLinks);
  $$payload.out += `<div class="aside-wrapper svelte-p8dzas"><aside class="svelte-p8dzas"><a href="/" class="logo-img svelte-p8dzas"><img src="/exe-squared-logo-low-res.png" alt="Logo" class="w-[200px] rounded-lg px-4 pt-4"></a> <hr> <input type="checkbox" id="hamburger-toggle" aria-hidden="true"${attr("checked", isOpen, true)} class="svelte-p8dzas"> <label for="hamburger-toggle" class="menu svelte-p8dzas" aria-hidden="true"><svg class="open-btn svelte-p8dzas" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>open menu</title><path d="M3,6H21V8H3V6M3,11H21V13H3V11M3,16H21V18H3V16Z"></path></svg> <svg class="close-btn svelte-p8dzas" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>close menu</title><path d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z"></path></svg></label> <nav class="svelte-p8dzas"><ul class="svelte-p8dzas"><!--[-->`;
  for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
    let link = each_array[$$index];
    $$payload.out += `<li>`;
    linkWithIcon($$payload, link);
    $$payload.out += `<!----></li>`;
  }
  $$payload.out += `<!--]--></ul> <hr> <ul class="additional svelte-p8dzas"><li><h4 class="subtitle">Admin</h4></li> <!--[-->`;
  ...
  $$payload.out += `<!--]--></ul> <hr> <ul class="additional svelte-p8dzas"><li class="flex items-end justify-between gap-4"><h4 class="subtitle">You</h4> `;
  ThemeSelector($$payload);
  $$payload.out += `<!----></li> `;
  linkWithIcon($$payload, {
    href: "/profile",
    label: "Profile",
    icon: User_outline,
    isActive: () => store_get($$store_subs ?? ($$store_subs = {}), "$page", page).url.toLowerCase().startsWith("/profile")
  });
  $$payload.out += `<!----> `;
  linkWithIcon($$payload, {
    href: "/logout",
  ...
  $$payload.out += `<!----></ul></nav></aside></div>`;
  if ($$store_subs) unsubscribe_stores($$store_subs);
  pop();
}
function ErrorLayout($$payload, $$props) {
  let { children } = $$props;
  $$payload.out += `<div class="wrapper svelte-3n8j4b"><main class="content-width">`;
  children($$payload);
...
const V = String.raw, z = BROWSER, $ = "--_number-flow-d-opacity", U = "--_number-flow-d-width", S = "--_number-flow-dx", j = "--_number-flow-d";
(() => {
  try {
...
class J extends G {
  ...
  set data(t) {
    ...
    if (this.created) {
      const c = this._data;
      this._data = t, this.computedTrend = typeof this.trend == "function" ? this.trend(c.value, o) : this.trend, this.computedAnimated = q, (r2 = this.plugins) == null || r2.forEach((d) => {
        var p;
...
class W {
  constructor(t, e, { justify: i, className: s, ...a }, o) {
    ...
    const r2 = e.map((c) => this.addChar(c).el);
    this.el = u("span", {
      ...a,
  ...
  addNewAndUpdateExisting(t) {
    ...
    if (X(t, (o) => {
      let r2;
      this.children.has(o.key) ? (r2 = this.children.get(o.key), i.set(o, r2), this.unpop(r2), r2.present = true) : (r2 = this.addChar(o, { startDigitsAtZero: true, animateIn: true }), e.set(o, r2)), this.el[a](r2.el);
...
class D extends B {
  constructor(t, e, i, s, a) {
    var d, p;
    const o = (((p = (d = t.flow.digits) == null ? void 0 : d[s]) == null ? void 0 : p.max) ?? 9) + 1, r2 = Array.from({ length: o }).map((C, g) => {
    ...
    }, this._numbers = r2, this.length = o;
  }
  willUpdate(t) {
  ...
  didUpdate(t) {
    ...
    const r2 = this.getDelta();
    r2 && (this.el.classList.add("is-spinning"), this.el.animate({
      [j]: [-r2, 0]
    }, {
...
const canAnimate = readable(false, (set2) => {
});
const prefersReducedMotion = readable(false, (set2) => {
});
derived([canAnimate, prefersReducedMotion], ([canAnimate2, prefersReducedMotion2]) => canAnimate2 && !prefersReducedMotion2);
function AuthenticatedLayout($$payload, $$props) {
  push();
  let { children, displaySidebar = true } = $$props;
  let isSidebarOpen = true;
  $$payload.out += `<!--[-->`;
  {
    $$payload.out += `<div${attr_class("wrapper svelte-bexq3q", void 0, { "no-sidebar": !displaySidebar })}>`;
    if (displaySidebar) {
      $$payload.out += "<!--[-->";
      $$payload.out += `<div class="side-bar svelte-bexq3q">`;
      Sidebar($$payload, { isOpen: isSidebarOpen });
      $$payload.out += `<!----></div>`;
    } else {
      $$payload.out += "<!--[!-->";
    }
    $$payload.out += `<!--]--> <main class="h-full overflow-auto">`;
    children($$payload);
    $$payload.out += `<!----></main></div>`;
  }
  $$payload.out += `<!--]-->`;
...
function GuestLayout($$payload, $$props) {
  $$payload.out += `<div class="bg-gray-100 dark:bg-gray-900 flex min-h-screen flex-col items-center pt-6 sm:justify-center sm:pt-0"><div><a href="/">`;
  ApplicationLogo($$payload, { class: "fill-current text-gray-500 h-20 w-20" });
  $$payload.out += `<!----></a></div> <div class="bg-white dark:bg-gray-800 mt-6 w-full overflow-hidden px-6 py-4 shadow-md sm:max-w-md sm:rounded-lg"><!---->`;
  slot($$payload, $$props, "default", {});
  $$payload.out += `<!----></div></div>`;
}
function Loading($$payload, $$props) {
  const { position = "fixed" } = $$props;
  $$payload.out += `<div class="loading-wrapper svelte-x9ld3x"${attr_style("", { position })}><div class="lds-roller svelte-x9ld3x"><div class="svelte-x9ld3x"></div> <div class="svelte-x9ld3x"></div> <div class="svelte-x9ld3x"></div> <div class="svelte-x9ld3x"></div> <div class="svelte-x9ld3x"></div> <div class="svelte-x9ld3x"></div> <div class="svelte-x9ld3x"></div> <div class="svelte-x9ld3x"></div></div></div>`;
}
function LoginLayout($$payload, $$props) {
  push();
  let isLoading = false;
  ...
  let { children } = $$props;
  const each_array = ensure_array_like(new Array(15));
  $$payload.out += `<div class="wrapper h-svh svelte-1xcw52n"><ul class="circles svelte-1xcw52n"><!--[-->`;
  for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
    each_array[$$index];
    $$payload.out += `<li class="svelte-1xcw52n"></li>`;
  }
  $$payload.out += `<!--]--></ul> <div class="content grid items-center justify-center svelte-1xcw52n"><div class="absolute right-8 top-8 svelte-1xcw52n">`;
  ThemeSelector($$payload);
  $$payload.out += `<!----></div> `;
  if (isLoading) {
    $$payload.out += "<!--[-->";
  ...
  $$payload.out += `<!--]--> <main class="z-40 rounded-2xl bg-surface-2 p-8 svelte-1xcw52n">`;
  children == null ? void 0 : children($$payload);
  $$payload.out += `<!----></main></div></div>`;
  pop();
}
const url = "https://laravel-svelte-template.local";
const port = null;
const defaults = [];
const routes = { "sanctum.csrf-cookie": { "uri": "sanctum/csrf-cookie", "methods": ["GET", "HEAD"] }, "register": { "uri": "register", "methods": ["POST"] }, "login": { "uri": "login", "methods": ["POST"] }, "password.email": { "uri": "forgot-password", "methods": ["POST"] }, "password.store": { "uri": "reset-password", "methods": ["POST"] }, "verification.verify": { "uri": "verify-email/{id}/{hash}", "methods": ["GET", "HEAD"], "parameters": ["id", "hash"] }, "verification.send": { "uri": "email/verification-notification", "methods": ["POST"] }, "logout": { "uri": "logout", "methods": ["POST"] }, "storage.local": { "uri": "storage/{path}", "methods": ["GET", "HEAD"], "wheres": { "path": ".*" }, "parameters": ["path"] } };
const wildcards = { "sanctum.*": [], "password.*": [], "verification.*": [], "storage.*": [] };
const routes$1 = {
  url,
  port,
  defaults,
...
const resolve = async (name) => {
  const page2 = await resolvePageComponent(
    `./Pages/${name}.svelte`,
    /* @__PURE__ */ Object.assign({ "./Pages/Admin/Users/Create.svelte": () => import("./assets/Create-B40xzlf0.js"), "./Pages/Admin/Users/Edit.svelte": () => import("./assets/Edit-2ssit0Zx.js"), "./Pages/Admin/Users/Index.svelte": () => import("./assets/Index-BPyWZQiq.js"), "./Pages/Admin/Users/Layout.svelte": () => import("./assets/Layout-CGT1_H_8.js"), "./Pages/Admin/Users/Partials/UpdateForm.svelte": () => import("./assets/UpdateForm-DWq6haHx.js"), "./Pages/Admin/Users/Show.svelte": () => import("./assets/Show-B_7Gf3ln.js"), "./Pages/Auth/ConfirmPassword.svelte": () => import("./assets/ConfirmPassword-BW6NU49i.js"), "./Pages/Auth/ForgotPassword.svelte": () => import("./assets/ForgotPassword-gWkRLYh9.js"), "./Pages/Auth/Login.svelte": () => import("./assets/Login-O2CwcE2e.js"), "./Pages/Auth/ResetPassword.svelte": () => import("./assets/ResetPassword-Bg9z74vX.js"), "./Pages/Auth/VerifyEmail.svelte": () => import("./assets/VerifyEmail-C3-JJM9t.js"), "./Pages/Dashboard.svelte": () => import("./assets/Dashboard-BQArbua-.js"), "./Pages/Error.svelte": () => import("./assets/Error-UhRjMIQJ.js"), "./Pages/Profile/Edit.svelte": () => import("./assets/Edit-B4xC4LFA.js"), "./Pages/Profile/Partials/DeleteUserForm.svelte": () => import("./assets/DeleteUserForm-C85pn5JJ.js"), "./Pages/Profile/Partials/UpdatePasswordForm.svelte": () => import("./assets/UpdatePasswordForm-_MjItyhg.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.svelte": () => import("./assets/UpdateProfileInformationForm-CnZuFsPC.js"), "./Pages/Welcome.svelte": () => import("./assets/Welcome-D2AEvinN.js") })
  );
  const layout = layoutMap[name] ?? AuthenticatedLayout;
  console.log({ page: page2, name, layout });
  return {
    default: page2.default,
    layout: page2.layout || layout
  };
};
createServer(
